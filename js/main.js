    ...
    angular.module('application', [])
        .controller('appCtrl', function($scope) {
            $scope.model = [
                ...
                {id: '2', 'country': 'Lebanon', 'sales': 150000,  color: '#1abc9c', selected: true},
                {id: '3', 'country': 'Iran', 'sales': 190000,  color: '#7CE343', selected: true},
                {id: '4', 'country': 'Oman', 'sales': 134000,  color: '#AF13F1', selected: true},
                {id: '5', 'country': 'Saudi Arabia', 'sales': 780000,  color: '#397EBD', selected: true},
                {id: '6', 'country': 'UAE', 'sales':  850000, color: '#F94D18', selected: true},
                {id: '7', 'country': 'Tunisia', 'sales': 320000,  color: '#FFE336', selected: true},
